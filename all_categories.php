 ...
 */
    ...
    class all_categoriesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('All Categories');
            $this->SetMenuLabel('All Categories');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'record_time', 'record_time', 'Record Time')
            );
        }
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['record_time']);
        }
    
        protected function setupColumnFilter(ColumnFilter $columnFilter)
        {
            $columnFilter
                ->setOptionsFor('category')
                ->setOptionsFor('record_time');
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new DateTimeEdit('record_time_edit', false, 'Y-m-d H:i:s');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for record_time field
            //
            $column = new DateTimeViewColumn('record_time', 'record_time', 'Record Time', $this->dataset);
            $column->SetOrderable(true);
    ...
    try
    {
        $Page = new all_categoriesPage("all_categories", "all_categories.php", GetCurrentUserPermissionsForPage("all_categories"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("all_categories"));
