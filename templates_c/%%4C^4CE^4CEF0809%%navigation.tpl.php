<?php if (( $this->_tpl_vars['HomePageEnabled'] || count ( $this->_tpl_vars['navigation'] ) > 1 )): ?>
    <ol class="breadcrumb pgui-breadcrumb">
        <?php if ($this->_tpl_vars['HomePageEnabled']): ?>
            <li><a href="<?php echo $this->_tpl_vars['HomePageURL']; ?>
