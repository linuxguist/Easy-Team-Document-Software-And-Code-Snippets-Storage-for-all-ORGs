...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'view/export_buttons.tpl', 12, false),)), $this); ?>
<?php if (isset ( $this->_tpl_vars['buttons']['excel'] ) || isset ( $this->_tpl_vars['buttons']['pdf'] ) || isset ( $this->_tpl_vars['buttons']['csv'] ) || isset ( $this->_tpl_vars['buttons']['xml'] ) || isset ( $this->_tpl_vars['buttons']['word'] )): ?>
    <div class="btn-group">
