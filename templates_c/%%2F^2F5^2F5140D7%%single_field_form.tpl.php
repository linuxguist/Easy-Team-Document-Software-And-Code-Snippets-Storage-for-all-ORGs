...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'forms/single_field_form.tpl', 16, false),)), $this); ?>
...
">
    ...
    <div class="col-input">
        <label class="control-label" data-column="<?php echo $this->_tpl_vars['ColumnViewData']['FieldName']; ?>
">
            <?php if ($this->_tpl_vars['ColumnViewData']['EditorHint']): ?>
                <span class="commented js-hint" data-hint="<?php echo $this->_tpl_vars['ColumnViewData']['EditorHint']; ?>
"><?php echo $this->_tpl_vars['ColumnViewData']['Caption']; ?>
</span>
            <?php else: ?>
                <?php echo $this->_tpl_vars['ColumnViewData']['Caption']; ?>
