...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'forms/actions_edit.tpl', 30, false),)), $this); ?>
<?php ob_start(); ?>
...
"><?php echo $this->_tpl_vars['Captions']->GetMessageString('SaveAndBackToList'); ?>
            ...
            <?php if ($this->_tpl_vars['EditOperationIsEnabled']): ?>
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['InsertOperationIsEnabled']): ?>
